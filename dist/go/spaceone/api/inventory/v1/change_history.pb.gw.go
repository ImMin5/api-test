...
var (
	filter_ChangeHistory_List_0 = &utilities.DoubleArray{Encoding: map[string]int{"cloud_service_id": 0, "cloudServiceId": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
func request_ChangeHistory_List_0(ctx context.Context, marshaler runtime.Marshaler, client ChangeHistoryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ChangeHistory_List_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	filter_ChangeHistory_List_1 = &utilities.DoubleArray{Encoding: map[string]int{"cloud_service_id": 0, "cloudServiceId": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)

func request_ChangeHistory_List_1(ctx context.Context, marshaler runtime.Marshaler, client ChangeHistoryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ChangeHistoryQuery
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ChangeHistory_List_1); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_ChangeHistory_List_1(ctx context.Context, marshaler runtime.Marshaler, server ChangeHistoryServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ChangeHistoryQuery
	var metadata runtime.ServerMetadata
...
var (
	filter_ChangeHistory_Stat_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_ChangeHistory_Stat_0(ctx context.Context, marshaler runtime.Marshaler, client ChangeHistoryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ChangeHistory_Stat_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterChangeHistoryHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ChangeHistoryServer) error {
	...
	mux.Handle("GET", pattern_ChangeHistory_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.inventory.v1.ChangeHistory/List", runtime.WithHTTPPathPattern("/inventory/v1/cloud-service/{cloud_service_id}/change-history"))
		if err != nil {
	...
	mux.Handle("POST", pattern_ChangeHistory_List_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.inventory.v1.ChangeHistory/List", runtime.WithHTTPPathPattern("/inventory/v1/cloud-service/{cloud_service_id}/change-history/search"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ChangeHistory_List_1(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ChangeHistory_List_1(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_ChangeHistory_Stat_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/spaceone.api.inventory.v1.ChangeHistory/Stat", runtime.WithHTTPPathPattern("/inventory/v1/cloud-service/change-history/stat"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterChangeHistoryHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ChangeHistoryClient) error {
	...
	mux.Handle("GET", pattern_ChangeHistory_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.inventory.v1.ChangeHistory/List", runtime.WithHTTPPathPattern("/inventory/v1/cloud-service/{cloud_service_id}/change-history"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ChangeHistory_List_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.inventory.v1.ChangeHistory/List", runtime.WithHTTPPathPattern("/inventory/v1/cloud-service/{cloud_service_id}/change-history/search"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ChangeHistory_List_1(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ChangeHistory_Stat_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/spaceone.api.inventory.v1.ChangeHistory/Stat", runtime.WithHTTPPathPattern("/inventory/v1/cloud-service/change-history/stat"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_ChangeHistory_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"inventory", "v1", "cloud-service", "cloud_service_id", "change-history"}, ""))

	pattern_ChangeHistory_List_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 2, 5}, []string{"inventory", "v1", "cloud-service", "cloud_service_id", "change-history", "search"}, ""))

	pattern_ChangeHistory_Stat_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"inventory", "v1", "cloud-service", "change-history", "stat"}, ""))
)

var (
	forward_ChangeHistory_List_0 = runtime.ForwardResponseMessage

	forward_ChangeHistory_List_1 = runtime.ForwardResponseMessage
